...
//		decision = va
    ...
    private void uponProposeRequest(ProposeRequest request, short sourceProto) {
        ...
        while (true) {
            ...
            PrepareMessage msgPrepare = new PrepareMessage(request.getInstance(),request.getOpId(), request.getOperation(), sn);
            ...
            if(nrPrepareOk >=  membership.size()){
                ...
                AcceptMessage msgAccept = new AcceptMessage(request.getInstance(),request.getOpId(), request.getOperation(), sn , proposeValue);
